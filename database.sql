...
VALUES
  ...
  (2, 1002, '2023-01-02', 'pembayaran'),
  (3, 1003, '2023-01-03', 'pembayaran'),
  (4, 1004, '2023-01-04', 'transfer_uang'),
  (5, 1005, '2023-01-05', 'pembayaran'),
  (6, 1006, '2023-01-06', 'transfer_uang'),
  (7, 1007, '2023-01-07', 'transfer_uang'),
  (8, 1008, '2023-01-08', 'transfer_uang'),
  (9, 1009, '2023-01-09', 'pembayaran'),
  (10, 1010, '2023-01-10', 'transfer_uang'),
  (11, 1011, '2023-01-11', 'transfer_uang'),
  (12, 1012, '2023-01-12', 'transfer_uang'),
  (13, 1013, '2023-01-13', 'transfer_uang'),
  (14, 1014, '2023-01-14', 'transfer_uang'),
  (15, 1015, '2023-01-15', 'pembayaran'),
  (16, 1016, '2023-01-16', 'transfer_uang'),
  (17, 1017, '2023-01-17', 'pembayaran'),
  (18, 1018, '2023-01-18', 'pembayaran'),
  (19, 1019, '2023-01-19', 'pembayaran'),
  (20, 1020, '2023-01-20', 'transfer_uang'),
  (21, 1021, '2023-01-21', 'pembayaran'),
  (22, 1022, '2023-01-22', 'transfer_uang'),
  (23, 1023, '2023-01-23', 'pembayaran'),
  (24, 1024, '2023-01-24', 'transfer_uang'),
  (25, 1025, '2023-01-25', 'pembayaran'),
  (26, 1026, '2023-01-26', 'transfer_uang'),
  (27, 1027, '2023-01-27', 'pembayaran'),
  (28, 1028, '2023-01-28', 'transfer_uang'),
  (29, 1029, '2023-01-29', 'pembayaran'),
  (30, 1030, '2023-01-30', 'pembayaran');
...
VALUES
  (1, 'BRI', 2500, 10001,'Antar Bank'),
  (2, 'Mandiri', 2500, 10002, 'Antar Bank'),
  (3, 'Ollabank', 0, 10003,'Sesama Rekening'),
  (4, 'BRI', 2500, 10004, 'Antar Bank'),
  (5, 'Bukopin', 2500, 10005, 'Antar Bank'),
  (6, 'UOB', 100000, 10006, 'Bank Internasional'),
  (7, 'BCA', 2500, 10007, 'Antar Bank'),
  (8, 'Ollabank', 0, 10008,'Sesama Rekening'),
  (9, 'Ollabank', 0, 10009,'Sesama Rekening'),
  (10, 'BRI', 2500, 10010, 'Antar Bank'),
  (11, 'Ollabank', 0, 10011,'Sesama Rekening'),
  (12, 'OCBC', 100000, 10012,'Bank Internasional'),
  (13, 'Ollabank', 0, 10013,'Sesama Rekening'),
  (14, 'BRI', 2500, 10014, 'Antar Bank'),
  (15, 'Maybank', 2500, 10015, 'Antar Bank'),
  (16, 'BNI', 2500, 10016, 'Antar Bank'),
  (17, 'Ollabank', 0, 10017,'Sesama Rekening'),
  (18, 'Ollabank', 0, 10018, 'Sesama Rekening'),
  (19, 'BRI', 2500, 10019, 'Antar Bank'),
  (20, 'Mandiri', 2500, 10020, 'Antar Bank'),
  (21, 'BCA', 2500, 10021,'Antar Bank'),
  (22, 'BRI', 2500, 10022, 'Antar Bank'),
  (23, 'Ollabank', 0, 10023,'Sesama Rekening'),
  (24, 'Ollabank', 0, 10024,'Sesama Rekening'),  
  (25, 'BTN', 2500, 10025, 'Antar Bank'),
  (26, 'Mandiri', 2500, 10026, 'Antar Bank'),
  (27, 'BCA', 2500, 10027, 'Antar Bank'),
  (28, 'Ollabank', 0, 10028,'Sesama Rekening'),
  (29, 'Mayapada', 2500, 10029, 'Antar Bank'),
  (30, 'Ollabank', 0, 10030,'Sesama Rekening');
